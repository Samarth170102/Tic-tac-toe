...
import 'package:flutter_application_9/HomeScreens/verify_email.dart';
...
class _SignUpState extends State<SignUp> {
  ...
  Future sendEmail(String email, String OTP) async {
    ...
    await http.post(url,
        ...
        body: json.encode({
          "service_id": "service_d6dj9zj",
          "template_id": "template_gofe0ai",
          "user_id": "user_3vNgvsasgec4rFCYukwnc",
  ...
  Widget build(BuildContext context) {
    VxState.watch(context, on: [ObsecurePasswordMutation]);
                    ...
                    TextFormField(
                      ...
                      validator: (value) {
                        if (value!.isEmpty) {
                          ...
                          error2 = "Password cannot have a space in it";
                        } else {
                          error2 = null;
                        }
                        return error2;
